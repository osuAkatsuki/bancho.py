...
insert into achievements (id, file, name, `desc`, cond, mode) values (41, 'fruits-skill-pass-1', 'A Slice Of Life', 'Hey, this fruit catching business isn''t bad.', '2 >= score.sr > 1', 2);
insert into achievements (id, file, name, `desc`, cond, mode) values (42, 'fruits-skill-pass-2', 'Dashing Ever Forward', 'Fast is how you do it.', '3 >= score.sr > 2', 2);
insert into achievements (id, file, name, `desc`, cond, mode) values (43, 'fruits-skill-pass-3', 'Zesty Disposition', 'No scurvy for you, not with that much fruit.', '4 >= score.sr > 3', 2);
insert into achievements (id, file, name, `desc`, cond, mode) values (44, 'fruits-skill-pass-4', 'Hyperdash ON!', 'Time and distance is no obstacle to you.', '5 >= score.sr > 4', 2);
insert into achievements (id, file, name, `desc`, cond, mode) values (45, 'fruits-skill-pass-5', 'It''s Raining Fruit', 'And you can catch them all.', '6 >= score.sr > 5', 2);
insert into achievements (id, file, name, `desc`, cond, mode) values (46, 'fruits-skill-pass-6', 'Fruit Ninja', 'Legendary techniques.', '7 >= score.sr > 6', 2);
insert into achievements (id, file, name, `desc`, cond, mode) values (47, 'fruits-skill-pass-7', 'Dreamcatcher', 'No fruit, only dreams now.', '8 >= score.sr > 7', 2);
insert into achievements (id, file, name, `desc`, cond, mode) values (48, 'fruits-skill-pass-8', 'Lord of the Catch', 'Your kingdom kneels before you.', '9 >= score.sr > 8', 2);
