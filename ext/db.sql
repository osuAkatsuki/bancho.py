...
(
	id int auto_increment
		primary key,
	tscore_vn_std int(11) unsigned default 0 not null,
	tscore_vn_taiko int(11) unsigned default 0 not null,
	tscore_vn_catch int(11) unsigned default 0 not null,
	tscore_vn_mania int(11) unsigned default 0 not null,
	tscore_rx_std int(11) unsigned default 0 not null,
	tscore_rx_taiko int(11) unsigned default 0 not null,
	tscore_rx_catch int(11) unsigned default 0 not null,
	tscore_ap_std int(11) unsigned default 0 not null,
	rscore_vn_std int(11) unsigned default 0 not null,
	rscore_vn_taiko int(11) unsigned default 0 not null,
	rscore_vn_catch int(11) unsigned default 0 not null,
	rscore_vn_mania int(11) unsigned default 0 not null,
	rscore_rx_std int(11) unsigned default 0 not null,
	rscore_rx_taiko int(11) unsigned default 0 not null,
	rscore_rx_catch int(11) unsigned default 0 not null,
	rscore_ap_std int(11) unsigned default 0 not null,
	pp_vn_std smallint(6) unsigned default 0 not null,
	pp_vn_taiko smallint(6) unsigned default 0 not null,
	pp_vn_catch smallint(6) unsigned default 0 not null,
	pp_vn_mania smallint(6) unsigned default 0 not null,
	pp_rx_std smallint(6) unsigned default 0 not null,
	pp_rx_taiko smallint(6) unsigned default 0 not null,
	pp_rx_catch smallint(6) unsigned default 0 not null,
	pp_ap_std smallint(6) unsigned default 0 not null,
